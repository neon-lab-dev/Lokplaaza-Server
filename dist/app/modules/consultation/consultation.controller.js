...
const getAllConsultations = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield consultation_services_1.ConsultationServices.getAllConsultations(keyword, Number(page), Number(limit));
    (0, sendResponse_1.default)(res, {
...
const getSingleConsultation = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield consultation_services_1.ConsultationServices.getSingleConsultation(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
